...
(function($) {
  ...
  $.fn.backgroundDraggable = function(options) {
    ...
    return this.each(function() {
      ...
      if (typeof optionsB == 'undefined' || typeof optionsB == 'object') {
        optionsB = $.extend({}, $.fn.backgroundDraggable.defaults, optionsB);
        var plugin = new Plugin(this, optionsB);
        $this.data('dbg', plugin);
      } else if (typeof optionsB == 'string' && $this.data('dbg')) {
        var pluginB = $this.data('dbg');
        Plugin.prototype[optionsB].apply(pluginB, args);
      }
    });
  };
